...
import net.devdoctor.bioshock.Networking.packet.ReloadC2SPacket;
...
public class ModPackaces {
    ...
    public static final Identifier RELOAD_ID = new Identifier(BioshockMod.MOD_ID, "reload");

    public static void registerC2SPackets() {
        ServerPlayNetworking.registerGlobalReceiver(USE_EVE_ID, EveDrinkingC2SPacket::receive);
        ServerPlayNetworking.registerGlobalReceiver(RELOAD_ID, ReloadC2SPacket::receive);
    }
